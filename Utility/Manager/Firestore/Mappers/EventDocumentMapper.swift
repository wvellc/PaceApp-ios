...
enum EventDocumentMapper {
		...
		//
		// Builds ActivityData directly from FirestoreEventDocument fields.
		// Does NOT round-trip through a [String: Any] payload — that pattern
		// allocated a new DateFormatter on every call and lost the stable document ID.
