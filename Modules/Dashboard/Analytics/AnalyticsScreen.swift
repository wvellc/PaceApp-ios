...
struct AnalyticsScreen: View {
	...
	@State private var selectedMetric: AnalyticsMetricType?
	...
	var body: some View {
		...
		// is registered at the stack level — not inside a lazy container (ScrollView).
		// Placing it inside ScrollView/VStack triggers the "misplaced navigationDestination"
		// warning and will be silently ignored in future SwiftUI releases.
		NavigationStack {
			VStack {
			...
			// any lazy container — so the stack can always see the destination.
